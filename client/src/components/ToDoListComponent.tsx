        ...
        return (
            <>
                <div className="w-full">
                    ...
                    <div className="mt-[40px] md:mt-[146px] lg:mt-[186px]">
                        <button 
                        className="relative w-full bg-teal-600 text-white py-2 rounded-br-[1.5rem] rounded-bl-[1.5rem] hover:bg-teal-700"
