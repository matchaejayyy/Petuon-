      ...
      <WhiteContainer>
          ...
          <Avatar/>
            <div>
              ...
              <div className="fixed bg-white w-[35rem] h-[13rem] top-[30rem] left-[10.5rem] rounded-[1.5rem]">Progress</div>
              <div className="fixed bg-white w-[45.5rem] h-[36rem] left-[47.5rem] rounded-[1.5rem]">Pets</div>
            </div>
        </WhiteContainer>
      <SideBar />
    </>
